...
@dso_cache = dso_local local_unnamed_addr global [640 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 39599125, ; hash 0x25c3c15, from name: aot-QSearch.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 390191546, ; hash 0x1741d9ba, from name: Plugin.LatestVersionStore
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 687779588, ; hash 0x28feaf04, from name: aot-Jurassic.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 879661098, ; hash 0x346e902a, from name: libaot-Jurassic.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Jurassic.dll.so
		ptr null; void* handle (0x0)
	}, ; 124
	...
	%struct.DSOCacheEntry {
		i64 1385291411, ; hash 0x5291de93, from name: aot-QSearch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QSearch.dll.so
		ptr null; void* handle (0x0)
	}, ; 193
	...
	%struct.DSOCacheEntry {
		i64 1751807674, ; hash 0x686a76ba, from name: aot-Plugin.LatestVersionStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Plugin.LatestVersionStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 1881834650, ; hash 0x702a849a, from name: libaot-Plugin.LatestVersionStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Plugin.LatestVersionStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 255
	...
	%struct.DSOCacheEntry {
		i64 1985845626, ; hash 0x765d997a, from name: libaot-QSearch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QSearch.dll.so
		ptr null; void* handle (0x0)
	}, ; 276
	...
	%struct.DSOCacheEntry {
		i64 2260609351, ; hash 0x86be2947, from name: libaot-QSearch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QSearch.dll.so
		ptr null; void* handle (0x0)
	}, ; 322
	%struct.DSOCacheEntry {
		i64 2263672642, ; hash 0x86ece742, from name: Jurassic
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Jurassic.dll.so
		ptr null; void* handle (0x0)
	}, ; 323
	...
	%struct.DSOCacheEntry {
		i64 2829270304, ; hash 0xa8a33d20, from name: aot-Plugin.LatestVersionStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Plugin.LatestVersionStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 415
	...
	%struct.DSOCacheEntry {
		i64 2952155965, ; hash 0xaff6533d, from name: libaot-Jurassic
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Jurassic.dll.so
		ptr null; void* handle (0x0)
	}, ; 435
	...
	%struct.DSOCacheEntry {
		i64 3042891718, ; hash 0xb55ed7c6, from name: QSearch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QSearch.dll.so
		ptr null; void* handle (0x0)
	}, ; 450
	...
	%struct.DSOCacheEntry {
		i64 3106700962, ; hash 0xb92c7ea2, from name: QSearch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-QSearch.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
	...
	%struct.DSOCacheEntry {
		i64 3119921545, ; hash 0xb9f63989, from name: libaot-Plugin.LatestVersionStore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Plugin.LatestVersionStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 470
	...
	%struct.DSOCacheEntry {
		i64 3652231055, ; hash 0xd9b09f8f, from name: Plugin.LatestVersionStore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Plugin.LatestVersionStore.dll.so
		ptr null; void* handle (0x0)
	}, ; 545
	...
	%struct.DSOCacheEntry {
		i64 4014864751, ; hash 0xef4df96f, from name: Jurassic.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Jurassic.dll.so
		ptr null; void* handle (0x0)
	}, ; 599
	...
	%struct.DSOCacheEntry {
		i64 4196535207, ; hash 0xfa220ba7, from name: aot-Jurassic
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-Jurassic.dll.so
		ptr null; void* handle (0x0)
	}, ; 627
